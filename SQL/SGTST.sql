...
) ENGINE = InnoDB AUTO_INCREMENT = 8 DEFAULT CHARACTER SET = utf8mb4;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 DEFAULT CHARACTER SET = utf8 COLLATE = utf8_bin;
...
CREATE TABLE IF NOT EXISTS `phpmyadmin`.`tb_funcionario` (
  ...
  CONSTRAINT `id_filial` FOREIGN KEY (`id_filial`) REFERENCES `phpmyadmin`.`tb_filial` (`id_filial`),
  CONSTRAINT `tb_funcionario_ibfk_1` FOREIGN KEY (`id_cargo`) REFERENCES `phpmyadmin`.`tb_cargo` (`id`),
  CONSTRAINT `tb_sangue_ibfk_1` FOREIGN KEY (`id_sangue`) REFERENCES `phpmyadmin`.`tb_sangue` (`id_sangue`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `phpmyadmin`.`tb_acesso` (
  ...
  CONSTRAINT `idCargo_fk_2` FOREIGN KEY (`id_cargo`) REFERENCES `phpmyadmin`.`tb_cargo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idFilial_fk_3` FOREIGN KEY (`id_filial`) REFERENCES `phpmyadmin`.`tb_filial` (`id_filial`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idFuncionário_fk_1` FOREIGN KEY (`id_funcionario`) REFERENCES `phpmyadmin`.`tb_funcionario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_bin;
...
CREATE TABLE IF NOT EXISTS `phpmyadmin`.`tb_lote_epi` (
  ...
  CONSTRAINT `tb_lote_epi_ibfk_1` FOREIGN KEY (`id_epi`) REFERENCES `phpmyadmin`.`tb_epi` (`id`),
  CONSTRAINT `tb_lote_epi_ibfk_2` FOREIGN KEY (`id_fornecedor`) REFERENCES `phpmyadmin`.`tb_fornecedor` (`id`)
...
CREATE TABLE IF NOT EXISTS `phpmyadmin`.`tb_uni_epi` (
  ...
  CONSTRAINT `tb_uni_epi_ibfk_1` FOREIGN KEY (`id_lote`) REFERENCES `phpmyadmin`.`tb_lote_epi` (`id`),
  CONSTRAINT `tb_uni_epi_ibfk_3` FOREIGN KEY (`id_estado`) REFERENCES `phpmyadmin`.`tb_estado` (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 6 DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `phpmyadmin`.`tb_acidentes` (
  ...
  CONSTRAINT `id_epi_fk_2` FOREIGN KEY (`id_epi`) REFERENCES `phpmyadmin`.`tb_uni_epi` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_funcionario_fk_1` FOREIGN KEY (`id_funcionario`) REFERENCES `phpmyadmin`.`tb_funcionario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 2 DEFAULT CHARACTER SET = utf8 COLLATE = utf8_bin;
...
CREATE TABLE IF NOT EXISTS `phpmyadmin`.`tb_alocacao` (
  ...
  CONSTRAINT `tb_alocacao_ibfk_1` FOREIGN KEY (`id_funcionario`) REFERENCES `phpmyadmin`.`tb_funcionario` (`id`),
  CONSTRAINT `tb_alocacao_ibfk_2` FOREIGN KEY (`id_uni`) REFERENCES `phpmyadmin`.`tb_uni_epi` (`id`)
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_bin;
